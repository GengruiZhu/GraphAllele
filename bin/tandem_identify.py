...
def main():
    ...
    parser.add_argument('--max_dist', type=int, default=5, help='Max gene distance (Defalut 5)')
    parser.add_argument('--min_ident', type=float, default=50.0, help='Min identity(Defalut50.0%)')
